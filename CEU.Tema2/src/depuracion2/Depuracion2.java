...
public class Depuracion2 {
	...
	public static void main(String[] args) {
		...
		for (int i = 0; i < numeros.length; i++) { //No debe ser <= ya que se saldría de los limites del array
	...
	public static int sumarNumeros(int a, int b) {	
		...
		int aux2 = b;
		aux = aux + aux2;
		return aux; //Se debe de hacer return a aux, no a aux2 ya que este no es el valor actualizado
	}
